    ...
    if (process.env.ANTHROPIC_API_KEY) {
      try {
        this.models.claude = new ChatAnthropic({
          ...
          modelName: "claude-3-haiku-20240307", // Claude 3 Haiku testado e funcionando
          temperature: 0.7,
          maxTokens: 1024,
        });
        this.modelPriority.push('claude');
        console.log("✅ Claude 3 Haiku inicializado (Prioridade 1)");
      } catch (error) {
